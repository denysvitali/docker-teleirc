...
config.tgToken = process.env.TIRC_TELEGRAM_TOKEN;
...
config.httpLocation = process.env.TIRC_HTTP_LOCATION;
...
config.ircNick = process.env.TIRC_IRC_NICKNAME;
config.ircServer = process.env.TIRC_IRC_SERVER;
...
config.channels = [
    ...
    {
        ircChan: process.env.TIRC_IRC_CHANNEL,
        tgGroup: process.env.TIRC_TELEGRAM_GROUP
    }
];
